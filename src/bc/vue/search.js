 ...
 * <pre>
 *   UI 使用：
 *   <bc-search [:advanced="true"] [:quickSearch="true"] [text="keys"] [placeholder="tips"] [@search="search"] [@change="change"]></bc-search>
 * 
 *   参数说明：
 *   <ul>
 *     <li>placeholder {String} [可选] 搜索框提示文字</li>
 *     <li>text {String} [可选] 搜索框默认输入的文字</li>
...
define(['vue'], function (Vue) {
  ...
  return Vue.component('bc-search', {
    ...
    '<input debounce="200" @keyup.enter="search" type="text" v-model="text" class="ui-widget-content" style="padding:.4em 18px;width:12em;min-height:1em;font-family:inherit;font-size:1.1em" :placeholder="placeholder">' +
    ...
    props: {
      ...
      text: { type: String, required: false, twoWay: true },
